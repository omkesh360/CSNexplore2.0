<?php
/**
 * Modern User Booking Confirmed Template
 * CSN Explore - Status Update
 */
$customer_name = htmlspecialchars($booking['full_name'] ?? 'Awesome Guest', ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <title>Your Booking is Confirmed! - CSN Explore</title>
    <style>
        ...
        .timeline { background-color: #ecfdf5; border-left: 4px solid #10b981; padding: 20px; border-radius: 0 12px 12px 0; margin-bottom: 30px; }
        .timeline-item { margin-bottom: 15px; }
        .timeline-item:last-child { margin-bottom: 0; }
        .timeline-title { font-size: 15px; font-weight: 700; color: #065f46; margin: 0 0 5px; }
        .timeline-desc { font-size: 14px; color: #047857; margin: 0; line-height: 1.5; }
        ...
        <table class="main" width="100%">
            ...
            <tr>
                <td class="content">
                    ...
                    <p class="message">Great news! Your booking with CSN Explore is <strong>officially confirmed</strong>. You are all set for an incredible adventure.</p>
                    ...
                    <div class="timeline">
                        <div class="timeline-item">
                            ...
                            <p class="timeline-desc">Just pack your bags! Our team might reach out shortly before your adventure for any final reminders.</p>
                        </div>
                    </div>
                    
                    <!-- Support -->
                    <div class="support">
                        <p>Questions about this confirmation?</p>
